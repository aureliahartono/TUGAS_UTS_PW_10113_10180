	...
	<div class="container min-vh-100 d-flex align-items-center justify-content-center">
			...
			<div class="card-header fw-bold">...</div>
                ...
                <?php
                    ...
                    $token = $_GET['t'];
                    $sql_cek = mysqli_query($koneksi, "SELECT * FROM tbl_member WHERE token='" . $token . "' and aktivasi='0'");
                    $jml_data = mysqli_num_rows($sql_cek);
                    if ($jml_data > 0) {
                        mysqli_query($koneksi, "UPDATE tbl_member SET aktivasi='1' WHERE token='" . $token . "' and aktivasi='0'");
